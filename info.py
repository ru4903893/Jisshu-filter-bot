...
SUPPORT_GROUP = (environ.get('SUPPORT_GROUP', 'https://t.me/rdx_movie1'))
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/rdx_movie1') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
